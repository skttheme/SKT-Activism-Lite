...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-activism-lite');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-activism-wordpress-theme/');?>" rel="nofollow noopener noreferrer" target="_blank">
        <?php esc_html_e('SKT Activism Lite','skt-activism-lite'); ?>
        </a></div>
     <div class="clear"></div>
</div>           
</div>
